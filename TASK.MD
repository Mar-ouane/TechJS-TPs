...
number of pages
- Create a class book have the following methods: a constructor, currentlyAt, deleteBook (and others needed to update or get a book info, and change the status or page read ..etc)
...
>note: track the project process and folder stucture on a ReadMe.md file
